public class Student {
    ...
    public void calcAvarage() {
        this.average = ((this.fizik.note * 0.9 + this.fizik.verbal * 0.1) + (this.kimya.note * 0.8 + this.kimya.verbal * 0.2)
                + (this.mat.note * 0.9 + this.mat.verbal * 0.1)) / 3;
    }
